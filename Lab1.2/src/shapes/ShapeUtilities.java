...
public class ShapeUtilities 
{
	...
	{	
		...
		case 3:
			return new Triangle(rand.nextInt(10), rand.nextInt(10), rand.nextInt(10));
		case 4:
			return new Parallelogram(rand.nextInt(10), rand.nextInt(10),rand.nextInt((int)(Math.PI/2)));
		case 5:
